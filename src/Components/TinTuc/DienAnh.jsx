    ...
    render() {
        return (
            <div className="container">
                ...
                <div className="d-flex justify-content-center mb-5"><ButtonDienAnh onClick={this.handleSetCount} className="btn">Xem Thêm </ButtonDienAnh></div>
            </div>
        )
    }
}
...
export default connect(mapStateToProps)(DienAnh)